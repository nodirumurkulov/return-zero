...
drop function if exists public.product_source_facts(uuid, integer, date);
drop function if exists public.product_monthly_series(uuid, integer);
drop function if exists public.product_daily_outflow(uuid, integer, date);
