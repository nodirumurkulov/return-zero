  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["owner_user_id", "variant_id"]
            isOneToOne: false
            referencedRelation: "variants"
            referencedColumns: ["owner_user_id", "variant_id"]
          },
        ]
      }
      ...
      line_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "line_items_order_fkey"
          ...
          {
            foreignKeyName: "line_items_product_fkey"
            columns: ["owner_user_id", "product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["owner_user_id", "product_id"]
          },
          {
            foreignKeyName: "line_items_variant_fkey"
            columns: ["owner_user_id", "variant_id"]
            isOneToOne: false
            referencedRelation: "variants"
            referencedColumns: ["owner_user_id", "variant_id"]
        ...
        Relationships: [
          {
            ...
            columns: ["owner_user_id", "customer_id"]
            isOneToOne: false
            referencedRelation: "customers"
            referencedColumns: ["owner_user_id", "customer_id"]
          },
        ]
      }
      orders_stream: {
      ...
      po_line_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "po_line_items_po_fkey"
            columns: ["owner_user_id", "po_id"]
            isOneToOne: false
            referencedRelation: "purchase_orders"
            referencedColumns: ["owner_user_id", "po_id"]
          },
          {
            foreignKeyName: "po_line_items_variant_fkey"
            columns: ["owner_user_id", "variant_id"]
            isOneToOne: false
            referencedRelation: "variants"
            referencedColumns: ["owner_user_id", "variant_id"]
      ...
      product_baselines: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_baselines_product_fkey"
            columns: ["owner_user_id", "product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["owner_user_id", "product_id"]
      ...
      product_cost_overrides: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_cost_overrides_product_fkey"
            columns: ["owner_user_id", "product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["owner_user_id", "product_id"]
      ...
      product_kpi_thresholds: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_kpi_thresholds_product_fkey"
            columns: ["owner_user_id", "product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["owner_user_id", "product_id"]
      ...
      refunds: {
        ...
        Relationships: [
          {
            foreignKeyName: "refunds_order_fkey"
            columns: ["owner_user_id", "order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["owner_user_id", "order_id"]
      ...
      support_tickets: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_tickets_customer_fkey"
            columns: ["owner_user_id", "customer_id"]
            isOneToOne: false
            referencedRelation: "customers"
            referencedColumns: ["owner_user_id", "customer_id"]
    ...
    Functions: {
      ...
      product_daily_outflow:
        ...
        | {
            Args: { p_asof?: string; p_days?: number; p_owner_user_id?: string }
            Returns: {
              current_balance: number
              daily_outflow: number
              product_id: string
      ...
      product_monthly_series:
        ...
        | {
            Args: { p_months?: number; p_owner_user_id?: string }
            Returns: {
              ad_revenue: number
              ad_spend: number
              month: string
