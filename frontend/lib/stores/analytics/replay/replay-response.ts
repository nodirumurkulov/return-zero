...
export const replayAdvanceResponseSchema = z.union([
  z.object({
...
export const replayOrdersResponseSchema = z.union([
  z.object({
    orders: z.array(
      z.object({
        order_id: z.string(),
...
export type ReplayAdvanceResponse = z.infer<typeof replayAdvanceResponseSchema>;
export type ReplayOrdersResponse = z.infer<typeof replayOrdersResponseSchema>;
