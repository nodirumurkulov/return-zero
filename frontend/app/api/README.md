...
| `GET` | `/api/shopify/auth` | Start Shopify OAuth (public; sets signed state cookie) |
| `GET` | `/api/shopify/callback` | Shopify OAuth callback (public; upserts connection + optional magic-link session) |
